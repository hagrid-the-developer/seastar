...
std::unordered_set<sstring> app_template::get_reloadable_options() {
    const auto set_reactor = reactor::get_reloadable_options();
    const auto set_seastar_metrics = seastar::metrics::get_reloadable_options();
    const auto set_smp = smp::get_reloadable_options();
    const auto set_scollectd = scollectd::get_reloadable_options();
    const auto set_log_cli = log_cli::get_reloadable_options();
